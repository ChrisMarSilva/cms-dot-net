...
public class TradeConfiguration : IEntityTypeConfiguration<TradeModel>
{
    public void Configure(EntityTypeBuilder<TradeModel> builder)
    {
        ...
        builder.Property(x => x.price_avg).HasColumnName("price_avg").HasColumnType("decimal(21,8)").IsRequired();
        builder.Property(x => x.quantity).HasColumnName("quantity").HasColumnType("decimal(21,8)").IsRequired();
        builder.Property(x => x.quantity_executed).HasColumnName("quantity_executed").HasColumnType("decimal(21,8)").IsRequired();
        builder.Property(x => x.instant_amount).HasColumnName("instant_amount").HasColumnType("decimal(21,8)").IsRequired();
        builder.Property(x => x.instant_amount_executed).HasColumnName("instant_amount_executed").HasColumnType("decimal(21,8)").IsRequired();
        builder.Property(x => x.created_at).HasColumnName("created_at").HasPrecision(3).IsRequired();
        builder.Property(x => x.trades_count).HasColumnName("trades_count").HasColumnType("numeric(9,0)").IsRequired();
        builder.Property(x => x.remark).HasColumnName("remark").HasMaxLength(250).IsRequired();
        builder.Property(x => x.funds_received).HasColumnName("funds_received").HasColumnType("decimal(21,8)").IsRequired();
    }
}