...
public class DatabaseIdentityServerInitializer : IDatabaseSeedInitializer
{
    ...
    public DatabaseIdentityServerInitializer(
    ...
    public void InitializeSeedUsers()
    {
        ...
        {
            var admin = new ApplicationUser() //define os dados do usuário admin
            {
                UserName = "admin1",
        ...
        {
            var client = new ApplicationUser() //define os dados do usuário client
            {
                UserName = "client1",
            ...
            if (resultClient.Succeeded)  //inclui o usuário Client ao perfil Client
            {
